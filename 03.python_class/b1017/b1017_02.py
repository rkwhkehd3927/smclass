...
### 함수선언 ###
def stuScore_update(k_title,s_title,s,choice):
  ...
  if choice == "1":
    ...
    for s in students:
      if s['name'] == search:
        ...
        if choice == 1: # subject 활용해서 국어 -> 변경
          stuScore_update("국어","kor",s,choice)
        elif choice == 2:
          stuScore_update("영어","eng",s,choice)
        elif choice == 3:
          stuScore_update("수학","math",s,choice)
        elif choice == 0:
          break
