...
class Member(models.Model):
    id = models.CharField(max_length=50, null=False, primary_key=True)  # 아이디
    pw = models.CharField(max_length=100,null=False)  # 패스워드
    name = models.CharField(max_length=100,null=False)  # 사용자명
